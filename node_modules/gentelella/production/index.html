      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <div class="col-md-9 col-sm-9 col-xs-12">
              <div class="dashboard_graph">
                <div class="row x_title">
                  <div class="col-md-6">
                    <h3> Patient Risk Scores <small> [0 - 5] </small></h3>
                  </div>
                </div>
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              <div class="title_left">
                <h3>Upcoming Appointments <small>Click to add/edit events</small></h3>
              </div>
            </div>
            <div class="col-md-9 col-sm-9 col-xs-12">
              <div class="x_panel">
          ...
          <script>
            ...
            $.post({
             url: "http://158.85.149.138:8080/riskpatient"    ,
             data: JSON.stringify({
            ...
            {
              var obj = {};
              obj.Date = new Date(data[i].time);
              obj.Risk = data[i].risk;
              console.log(obj.Date + " - " + data[i].time + " - " + obj.Risk);
              newData.push(obj);
            }
       ...
       function getParameterByName(name, url) {
        ...
        $(window).load(function() {
          ...
          categoryClass;
          $.post({
           url: "http://158.85.149.138:8080/getnote"    ,
           data: JSON.stringify({
             'patient_id' : getPatientId()
           })
          }).done(function(data) {
          ...
          {
              var event = {};
              event.title = data.notes[i].notetext;
              event.start = new Date(data.notes[i].created);
