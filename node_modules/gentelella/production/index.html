...
<html lang="en">
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-clock-o"></i> Alerts</span>
              <div class="count">5</div>
              <span class="count_bottom"><i class="red"><i class="fa fa-sort-asc"></i>2 </i> Require Attention</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
    ...
    var line = d3.line()
        ...
        .y(function(d) { return y(d.MinutesAsleep); });

    d3.tsv("data/sleepdata.tsv", function(d) {
      d.Date = parseTime(d.Date);
      d.MinutesAsleep = d.MinutesAsleep;
      return d;
    }, function(error, data) {
      if (error) throw error;

      x.domain(d3.extent(data, function(d) { return d.Date; }));
      y.domain(d3.extent(data, function(d) { return d.MinutesAsleep; }));
